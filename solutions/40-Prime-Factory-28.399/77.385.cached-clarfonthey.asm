...
-- 40-Prime-Factory - SIZE 77/28 - SPEED 385/399 --

-- This caches the list of found primes when checking numbers, but starts with
-- the cache pre-filled to speed up the solution. Effectively, this is like
-- having the speedup of an input-specific solution and the robustness of a
...
DEFINE LABEL 18
eJwTZWBgyIv9rjM98nZEQcStAvuIzKaCiGPdMVFmk27HJE32zprS/LZcMt+g+nmaYN2GcKe66cEldRxO
MrVLDQXrTJyd6uJi6monbV5fe2e/U53PMfb6xScYRsEoGAVDBgAAARAkYw;
